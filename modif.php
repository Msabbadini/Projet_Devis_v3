    ...
    <form>
      <div class="shadow overflow-hidden sm:rounded-md">
        ...
        <div class="px-4 py-3 bg-gray-50 text-right sm:px-6">
            <input type="submit" id='modif_client' class="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-green-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500" value='Modifier'>
          </div>
      </div>
    </form>
</div>
...
$('#modif_client').submit(function(){ 
            $.ajax({
            url : 'fonctions/update.php',
            data : $('#modif_client').serialize(),
            type : 'POST',
