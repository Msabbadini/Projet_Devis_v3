...
// Ajout Client Start
// Verif js jquery valide form pour la premiere verif en js a faire 
...
if($ret['status'] == 'ok'){
$ret['html'] = "<span style='color:green'>Votre ajout client est bien pris en compte</span>";
} else {
$ret['html'] = "<span style='color:red'>Corriger les erreurs pour pouvoir continuer</span>";
}
