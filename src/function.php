...
//   $req= $db->select('SELECT * FROM clients ORDER BY date_creation',null);
    ...
    <td class="px-6 py-4 whitespace-no-wrap text-right border-b border-gray-500 text-sm leading-5">
        <button data-id='<?= $r['id_client'] ?>' class="info px-5 py-2 border-blue-500 border text-blue-500 rounded transition duration-300 hover:bg-indigo-700 hover:text-white focus:outline-none">View Details</button>
        <button class="update px-5 py-2 border-blue-500 border text-blue-500 rounded transition duration-300 hover:bg-green-500 hover:text-white focus:outline-none ease-liner " data-role='update' data-id='<?= $r['id_client'] ?>' type='button' onclick='toggleModal("modal-id")' >Modification</button>
