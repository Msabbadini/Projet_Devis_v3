      ...
      <form id='ajout_client' method='post'>
        ...
        <span id="ville-error" class="error text-indigo-500"></span>
          ...
          <div class="px-4 py-3 bg-gray-50 text-right sm:px-6">
            ...
            <button id='ajout_client_btn' class="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500">
              Ajouter
            </button>
          </div>
        </div>
