...
<div class="w-screen h-screen overflow-hidden flex justify-center items-center bg-white">
    <div class="w-full my-2 md:w-3/5 lg:w-2/5">
        <div class="flex justify-center items-center mt-10 mb-20">
                <svg version="1.1" id="Capa_2" width="100px" height="100px" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
    ...
    <div class="flex my-8 mx-4 md:mx-2 border-b-2 border-gray-700 hover:border-green-800">
            <label class="self-center">
                ...
                viewBox="0 0 483.3 483.3" style="enable-background:new 0 0 483.3 483.3;display:inline" xml:space="preserve">
        ...
        <input class="w-full py-3 pl-5 md:pl-20 border-0 focus:outline-none" type="email" placeholder="johndoe@gmail.com" autocomplete="on" required>
    </div>
        <div class="flex my-8 mx-4 md:mx-2 border-b-2 border-gray-700 hover:border-green-800">
