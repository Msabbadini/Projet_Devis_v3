...
<div class="-my-2 py-2 overflow-x-auto ">
      ...
      <button class="rtn px-5 py-2 border-blue-500 border text-blue-500 rounded transition duration-300 hover:bg-indigo-500 hover:text-white focus:outline-none" type='button' data-id_client=''>Retour</button>
      </div>
    </div>
<div class="-my-2 py-2 overflow-x-auto ">
                ...
                <div class="align-middle inline-block min-w-full shadow overflow-hidden bg-white shadow-dashboard px-8 pt-3 rounded-bl-lg rounded-br-lg">
                    <table class="min-w-full">
                        ...
                        <?php
                            ...
                            ?>
                            <tr>
                            <td class="px-6 py-4 whitespace-no-wrap border-b text-blue-900 border-gray-500 text-sm leading-5"><?= $d['detail_num'] ?> <input type="text" value='<?=$d['detail_num'] ?>'></td>
                            <td class="px-6 py-4 whitespace-no-wrap border-b text-blue-900 border-gray-500 text-sm leading-5"><?= $d['detail_num'] ?> <input type="text" value='<?=$d['article_designation'] ?>'></td>
                            <td class="px-6 py-4 whitespace-no-wrap border-b text-blue-900 border-gray-500 text-sm leading-5"><?= $d['detail_num'] ?> <input type="text" value='<?=$d['details_qte'] ?>'></td>
                            <td class="px-6 py-4 whitespace-no-wrap border-b text-blue-900 border-gray-500 text-sm leading-5"><?= $d['detail_num'] ?> <input type="text" value='<?=$d['details_qte']*$d['article_prix'] ?>'></td>
                            <td><button type='button' data-id_article='<?=$d['detail_num']?>' data-id_devis='<?= $d['devis_num']?>' class='bg-indigo-500 text-white w-16 rounded-md remove_row'>X</button></td>
                            </tr>
                        <?php
                                    }
                                }
